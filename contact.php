...
<head>
    <meta charset="utf-8" />
    <title>Graziela Ribeiro Teçari Ropelato</title>

    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <meta name="author" content="Graziela Ribeiro Teçari Ropelato" />
    <meta name="description"
        content="Portifólio de trabalhos realizados e formação de Graziela Ribeiro Teçari Ropelato" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpeg"
